...
3. **Mapeo de Nombres**: Toma una muestra de filas de la hoja de cálculo y evalúa qué columna tiene mayor similitud léxica (normalizada) con los nombres de productos existentes en la base de datos de Supabase para ese esquema. Dicha columna se marca como la **Columna de Nombres**.

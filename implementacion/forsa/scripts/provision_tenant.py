#!/usr/bin/env python3
"""Alta de tenant forsa: schema + clone gonzales + fila en public.distribuidoras + owner.

Confirmado: schema_name = forsa, tenant nuevo / vacío (demo). Sin abrir rama.
"""
...
def create_auth_user() -> str:
    ...
    resp = requests.post(
        ...
        json={
            ...
            "email_confirm": True,
            "user_metadata": {"nombre": "Admin Forsa"},
        },
        timeout=30,
    )

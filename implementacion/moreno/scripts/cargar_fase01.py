#!/usr/bin/env python3
"""Carga Fase 1 catálogo en schema moreno desde CSVs (confirmación implementador)."""
...
SCHEMA = "moreno"  # confirmado por implementador
...
async def cargar() -> int:
    ...
    print("OK carga catálogo moreno completada")
    return 0

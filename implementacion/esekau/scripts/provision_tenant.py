#!/usr/bin/env python3
"""Alta de tenant esekau: clone gonzales + fila en public.distribuidoras + owner.

schema_name = esekau (confirmado: carpeta ESEKAU / Excel ESEKA-U Córdoba).
Tenant nuevo / vacío (demo). Rama hub: feat/quimica-vm-catalogo.
"""
...
SCHEMA = "esekau"  # confirmado: implementador / carpeta ESEKAU
SOURCE = "gonzales"
ADMIN_EMAIL = "admin@esekau.com"
...
def create_auth_user() -> str:
    ...
    resp = requests.post(
        ...
        json={
            ...
            "email_confirm": True,
            "user_metadata": {"nombre": "Admin Eseka-U"},
        },
        timeout=30,
    )

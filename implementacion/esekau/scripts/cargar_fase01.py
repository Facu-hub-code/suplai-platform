#!/usr/bin/env python3
"""Carga Fase 1 catálogo en schema esekau desde CSVs (95 SKUs demo).

schema_name = esekau (confirmado por el implementador: confirmar carga).
"""
...
SCHEMA = "esekau"  # confirmado: implementador
...
async def cargar() -> int:
    ...
    try:
        ...
        await conn.execute(
            ...
            VALUES
              (1, 'Lista 1', 'Lista Base Córdoba', true, true, true, now(), now()),

#!/usr/bin/env python3
"""Alta de tenant sunde: clone gonzales + fila en public.distribuidoras + owner.

schema_name = sunde (confirmado por el implementador). Tenant nuevo / vacío (demo).
"""
...
SCHEMA = "sunde"  # confirmado: implementador
SOURCE = "gonzales"
ADMIN_EMAIL = "admin@sunde.com"
...
def create_auth_user() -> str:
    ...
    resp = requests.post(
        ...
        json={
            ...
            "email_confirm": True,
            "user_metadata": {"nombre": "Admin SUNDE"},
        },
        timeout=30,
    )
...
async def main() -> int:
    ...
    try:
        ...
        tenant_id = uuid4()
        metadata = {
            "ciudad_base": "Río Cuarto, Córdoba, Argentina",

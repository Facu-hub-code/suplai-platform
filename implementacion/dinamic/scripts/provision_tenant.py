#!/usr/bin/env python3
"""Alta de tenant dinamic: clone gonzales + fila en public.distribuidoras + owner.

schema_name = dinamic (confirmado por el implementador). Tenant nuevo / vacío (demo).
"""
...
SCHEMA = "dinamic"  # confirmado: implementador
SOURCE = "gonzales"
ADMIN_EMAIL = "admin@dinamic.com"
...
def create_auth_user() -> str:
    ...
    resp = requests.post(
        ...
        json={
            ...
            "email_confirm": True,
            "user_metadata": {"nombre": "Admin Dinamic"},
        },
        timeout=30,
    )
...
async def main() -> int:
    ...
    try:
        ...
        tenant_id = uuid4()
        metadata = {
            "ciudad_base": "Casilda, Santa Fe, Argentina",
